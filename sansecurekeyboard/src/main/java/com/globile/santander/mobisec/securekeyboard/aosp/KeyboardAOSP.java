...
public class KeyboardAOSP {
     ...
     * Some of the key size defaults can be overridden per row from what the {@link KeyboardAOSP}
     * defines.
     *
     * @attr ref android.R.styleable#Keyboard_keyWidth
     * @attr ref android.R.styleable#Keyboard_keyHeight
    ...
    public static class Row {
         ...
         * {@link KeyboardAOSP#EDGE_TOP EDGE_TOP} and {@link KeyboardAOSP#EDGE_BOTTOM EDGE_BOTTOM}
         */
        ...
        public Row(KeyboardAOSP parent) {
            this.parent = parent;
        }

        public Row(Resources res, KeyboardAOSP parent, XmlResourceParser parser) {
            this.parent = parent;
            TypedArray a = res.obtainAttributes(Xml.asAttributeSet(parser),
                    R.styleable.KeyboardAOSP);
            defaultWidth = getDimensionOrFraction(a,
                    R.styleable.KeyboardAOSP_keyWidth,
                    parent.mDisplayWidth, parent.mDefaultWidth);
            defaultHeight = getDimensionOrFraction(a,
                    R.styleable.KeyboardAOSP_keyHeight,
                    parent.mDisplayHeight, parent.mDefaultHeight);
            defaultHorizontalGap = getDimensionOrFraction(a,
                    R.styleable.KeyboardAOSP_horizontalGap,
                    parent.mDisplayWidth, parent.mDefaultHorizontalGap);
            verticalGap = getDimensionOrFraction(a,
                    R.styleable.KeyboardAOSP_verticalGap,
    ...
    public static class Key {
         ...
         * {@link KeyboardAOSP#EDGE_LEFT}, {@link KeyboardAOSP#EDGE_RIGHT}, {@link KeyboardAOSP#EDGE_TOP} and
         * {@link KeyboardAOSP#EDGE_BOTTOM}.
         */
     ...
     */
    public KeyboardAOSP(Context context, @XmlRes int xmlLayoutResId, int modeId, int width,
            int height) {
        mDisplayWidth = width;
     ...
     * @param modeId         keyboard mode identifier
     */
    public KeyboardAOSP(Context context, @XmlRes int xmlLayoutResId, int modeId) {
     ...
     */
    public KeyboardAOSP(Context context, int layoutTemplateResId,
